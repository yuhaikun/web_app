...
func GetPostListHandler2(c *gin.Context) {
	// get请求(query string)：/api/v1/post2?page=1&size=10&order=time
	// 初始化结构体时指定初始参数
	p := &models.ParamPostList{
		Page:  models.PageInit,
		Size:  models.SizeInit,
